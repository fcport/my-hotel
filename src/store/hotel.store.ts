import { createHotel, getAllHotels, saveHotelRooms } from '@/composables/hotel'
...
export const useHotelStore = defineStore('hotel', () => {
  ...
  async function saveRoomsForHotel(hotelId: string, roomsData: Room[]) {
    const res = await saveHotelRooms(hotelId, roomsData)
    console.log(res)
    await getHotels()
  }
